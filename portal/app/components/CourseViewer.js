                        ...
                        <div className="space-y-16">
                           ...
                           <section>
                              <div className="flex items-center gap-4 mb-8">
                                 ...
                                 <h4 className="text-xl font-black text-slate-900 tracking-tight uppercase">Teacher's Explanation</h4>
                              </div>
                              <p className="text-[17px] text-slate-600 leading-relaxed font-medium selection:bg-indigo-100 selection:text-indigo-900 bg-indigo-50/30 p-8 rounded-[2rem] border border-indigo-100/50">
                                 {selectedLesson.explanation}
                              </p>
                           </section>
                           ...
                           {selectedLesson.example && (
                              <section>
                                 <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <h4 className="text-xl font-black text-slate-900 tracking-tight uppercase">Live Example</h4>
                                 </div>
                                 <div className="bg-[#0D1117] rounded-[2rem] overflow-hidden border border-slate-800 shadow-2xl">
                                    <div className="flex items-center justify-between px-6 py-4 bg-white/5 border-b border-white/5">
                                       <div className="flex items-center gap-2">
                                          <div className="w-3 h-3 rounded-full bg-[#FF5F56]"></div>
                                          <div className="w-3 h-3 rounded-full bg-[#FFBD2E]"></div>
                                       ...
                                       <span className="text-[10px] font-mono text-slate-500 uppercase tracking-[0.2em] font-bold">java.main.impl</span>
                                    </div>
                                    <pre className="p-8 text-[14px] text-[#E6EDF3] font-mono leading-relaxed overflow-x-auto">
                              ...
                              <section className="bg-slate-900 p-10 rounded-[2.5rem] text-white relative overflow-hidden group">
                                 <div className="relative z-10">
                                    <div className="flex items-center gap-3 mb-6">
                                       ...
                                       <h4 className="text-[13px] font-black uppercase tracking-widest">The Core Insight</h4>
                                    </div>
                                    <p className="text-[14px] text-slate-300 font-medium leading-relaxed italic">"{selectedLesson.summary}"</p>
                                 </div>
                              </section>
                              ...
                              <section className="bg-indigo-600 p-10 rounded-[2.5rem] text-white relative overflow-hidden group">
                                 <div className="relative z-10">
                                    <div className="flex items-center gap-3 mb-6">
                                       ...
                                       <h4 className="text-[13px] font-black uppercase tracking-widest">Practice Task</h4>
                                    </div>
                                    <p className="text-[14px] font-black leading-tight uppercase tracking-tight">{selectedLesson.practiceTask}</p>
                                 </div>
                                 <div className="absolute bottom-0 right-0 p-8 opacity-20">
                                    <span className="material-symbols-outlined text-6xl">edit_square</span>
                                 </div>
                              </section>
                           </div>
                        </div>
